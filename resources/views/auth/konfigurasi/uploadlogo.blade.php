    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="formupload" enctype="multipart/form-data" method="POST">
                ...
                <br>
                <center>
                    <img class="img-thumbnail" width="70%" src="{{ url('img/konfigurasi/logo/'  . $list->logo) }}" alt="Logo Website">
                </center>
...
<script>
    $(document).ready(function() {
        $('.btnupload').click(function(e) {
            e.preventDefault();
            let logoweb = "{{ url('img/konfigurasi/logo/'  . $list->logo) }}";
            ...
            $.ajax({
                type: "post",
                url: "{{ url('konfigurasi/douploadlogo') }}",
                data: data,
