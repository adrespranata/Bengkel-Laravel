                        ...
                        <td>
                            ...
                            <table border="1" style="border-collapse: collapse; border-spacing: 0; width: 100%; text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <input type="hidden" value="{{ $totalSeluruhHarga += $row->jual_total }}">
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $row->jual_faktur }}</td>
                                            <td>{{ date('d-m-Y', strtotime($row->jual_date)) }}</td>
                                            <td>{{ number_format($row->jual_total, 0, ',', '.') }} </td>
                                        </tr>
                                    @endforeach
