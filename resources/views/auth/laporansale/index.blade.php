...
<div class="col-sm-6">
    <ol class="breadcrumb float-right">
        <li class="breadcrumb-item"><a href="javascript:void(0);">Laporan Sale</a></li>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('laporan/cetaksale') }}" target="_blank">
...
<script>
    $('#btnCetak').click(function (e) { 
        ...
        window.location.href = ("{{ url('laporan/cetaksale/') }}") + '/' + tglawal + '/' + tglakhir;
    });
    ...
    function tampilGrafik() {
        $.ajax({
            type: "get",
            url: "{{ url('laporan/tampilGrafikSale') }}",
            dataType: "json",
            data: {
                bulan: $('#bulan').val()
            },
